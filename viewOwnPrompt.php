...
<body>
    <div class="content">
        ...
        <section class="rightContainer">
            <div class='likes dark'>
                ...
                <p data-id="<?php echo $prompt["prompts"][0]->getId(); ?>" class = "like">
                    <span class='like' id = "counter" ><?php echo Prompts::getPromptLike($prompt["prompts"][0]->getId()); ?></span>
                    Likes 
                </p>
            </div>
    ...
    <form action=""  method="POST" class= "middleForm">
            <h2>You want to delete prompt <?php  echo htmlspecialchars($prompt['prompts'][0]->promptName)?> </h2>
            <p>Are you sure?</p>
            <div class="form-element">
