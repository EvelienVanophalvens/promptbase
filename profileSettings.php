...
<body>
    <div class="context">
        ...
        <p>Attention: You are currently logged in as <?php echo $_SESSION['auth_user']['username']; ?>. <br>When you delete this account, you wont be able to log in again!</p>
        <form action="deleteaccount.php" method="POST">
            <button  name="user_delete" class="submit small danger" type="submit" value="<?= $_SESSION['auth_user']['username'];?>">Delete account</button>
        </form>
    </div>
</body>
</html>