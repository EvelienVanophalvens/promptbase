    ...
    <div class="content">
        ...
        <section class="leftContainer" >
            <div class="promptUserInfo">
                <div class="half">
                    <p><strong>Made by </strong><a href="../accountView.php?user=<?php echo htmlspecialchars($prompt["prompts"]["user"])?>" ><?php echo htmlspecialchars($prompt["prompts"]['username'])?></a></p>
        ...
        <section class="rightContainer">
            <div>
                ...
                <input type="submit" name="dontBlock" value="don't block">
